...
function mostraIMC (altura, peso){
    //verifica se os inputs estão vazios
   if (document.getElementById('altura').value == '' || document.getElementById('peso').valuee == ''){
        ...
        infoIMC.setAttribute("class", "info2");
